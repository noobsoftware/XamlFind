...
namespace XamlFind {
    public class base_page : Xamarin.Forms.ContentPage {
        ...
        public Element copy(Element element) {
            Element element1 = (Element)new Xamarin.Forms.Grid();
            ...
            switch(str1)  {
                ...
                case "MR.Gestures.StackLayout":
                    ...
                    break;*/
				case "Xamarin.Forms.SwitchCell":
                    element1 = (Element)new Xamarin.Forms.SwitchCell();
                    break;
                case "Xamarin.Forms.TextCell":
                    element1 = (Element)new Xamarin.Forms.TextCell();
                    break;
                case "Xamarin.Forms.ImageCell":
                    element1 = (Element)new Xamarin.Forms.ImageCell();
                    break;
                case "Xamarin.Forms.EntryCell":
                    element1 = (Element)new Xamarin.Forms.EntryCell();
                    break;
                case "Xamarin.Forms.TableView":
                    element1 = (Element)new Xamarin.Forms.TableView();
                    break;
                case "Xamarin.Forms.Switch":
                    element1 = (Element)new Xamarin.Forms.Switch();
                    break;
                case "Xamarin.Forms.Stepper":
                    element1 = (Element)new Xamarin.Forms.Stepper();
                    break;
                case "Xamarin.Forms.Slider":
                    element1 = (Element)new Xamarin.Forms.Slider();
                    break;
                case "Xamarin.Forms.Image":
                    element1 = (Element)new Xamarin.Forms.Image();
                    break;
                case "Xamarin.Forms.AbsoluteLayout":
                    element1 = (Element)new Xamarin.Forms.AbsoluteLayout();
                    break;
                case "Xamarin.Forms.BoxView":
                    element1 = (Element)new Xamarin.Forms.BoxView();
                    break;
                case "Xamarin.Forms.Button":
                    element1 = (Element)new Xamarin.Forms.Button();
                    break;
                case "Xamarin.Forms.Entry":
                    element1 = (Element)new Xamarin.Forms.Entry();
                    break;
                case "Xamarin.Forms.Frame":
                    element1 = (Element)new Xamarin.Forms.Frame();
                    break;
                case "Xamarin.Forms.Grid":
                    element1 = (Element)new Xamarin.Forms.Grid();
                    break;
                case "Xamarin.Forms.Label":
                    element1 = (Element)new Xamarin.Forms.Label();
                    break;
                case "Xamarin.Forms.StackLayout":
                    element1 = (Element)new Xamarin.Forms.StackLayout();
                    break;
                case "Xamarin.Forms.ScrollView":
                    element1 = (Element)new Xamarin.Forms.ScrollView();
                    break;
                case "Xamarin.Forms.Picker":
                    element1 = (Element)new Xamarin.Forms.Picker();
                    break;
                case "Xamarin.Forms.DatePicker":
                    element1 = (Element)new Xamarin.Forms.DatePicker();
                    break;
                case "Xamarin.Forms.TimePicker":
                    element1 = (Element)new Xamarin.Forms.TimePicker();
                    break;
                case "Xamarin.Forms.Editor":
                    element1 = (Element)new Xamarin.Forms.Editor();
                    break;
                case "Xamarin.Forms.FlexLayout":
                    element1 = (Element)new Xamarin.Forms.FlexLayout();
                    break;
                /*case "Xamarin.Forms.CheckBox":
                    element1 = (Element)new Xamarin.Forms.CheckBox();
                    break;
                */
            ...
            Rectangle layoutBounds = Xamarin.Forms.AbsoluteLayout.GetLayoutBounds((BindableObject)element);
            Xamarin.Forms.AbsoluteLayout.SetLayoutBounds((BindableObject)element1, layoutBounds);
            Xamarin.Forms.AbsoluteLayout.SetLayoutFlags((BindableObject)element1, Xamarin.Forms.AbsoluteLayout.GetLayoutFlags((BindableObject)element));
            if(str1 == "Xamarin.Forms.Grid") {
            ...
            foreach(Element child in this.children(element)) {
                ...
                if(str1 == "Xamarin.Forms.Grid") {
                    int row = Xamarin.Forms.Grid.GetRow((BindableObject)child);
                    int column = Xamarin.Forms.Grid.GetColumn((BindableObject)child);
					int row_span = Xamarin.Forms.Grid.GetRowSpan(child);
					int col_span = Xamarin.Forms.Grid.GetColumnSpan(child);
                    Xamarin.Forms.Grid.SetRow((BindableObject)view, row);
                    Xamarin.Forms.Grid.SetColumn((BindableObject)view, column);
					Xamarin.Forms.Grid.SetRowSpan(view, row_span);
					Xamarin.Forms.Grid.SetColumnSpan(view, col_span);
                }
                foreach(FieldInfo field in element1.GetType().GetFields(BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic)) {
                    if(field.Name == "_logicalChildren") {
                        ...
                        string str2 = str1;
                        if(!(str2 == "Xamarin.Forms.Grid")) {
                            if(str2 == "Xamarin.Forms.AbsoluteLayout") {
                                ((Xamarin.Forms.AbsoluteLayout)element1).Children.Add(view);
							}
                        } else {
                            ((Xamarin.Forms.Grid)element1).Children.Add(view);
						}
                    } else if(str1 == "Xamarin.Forms.Frame") {
                        ((Xamarin.Forms.ContentView)element1).Content = view;
                    } else if(str1 == "Xamarin.Forms.StackLayout") {
                        ((Layout<View>)element1).Children.Add(view);
					} else if(str1 == "Xamarin.Forms.ScrollView") {
                        ((Xamarin.Forms.ScrollView)element1).Content = view;
                    } else if(str1 == "Xamarin.Forms.FlexLayout") {
                        ((Xamarin.Forms.FlexLayout)element1).Children.Add(view);
                    }
                }
            }
            return element1;
        ...
        public List<Element> _(string selector) {
            return this.find((Element)NameScopeExtensions.FindByName<Xamarin.Forms.AbsoluteLayout>(this, "body_wrap"), selector);
        }
                ...
                if(((!flag || traverse_children) && !this.immiediate_children) || (this.immiediate_children && !flag)) {
					...
					foreach(FieldInfo fieldInfo in fields) {
						...
						if(fieldInfo.Name == "_logicalChildren") {
							...
							if(!(element_type == "Xamarin.Forms.Grid")) {
								if(element_type == "Xamarin.Forms.AbsoluteLayout") {
									foreach(Element child in ((Xamarin.Forms.AbsoluteLayout)element).Children) {
										this.traverse(child, type_sel, class_sel, selector_index);
									}
								}
							} else {
								foreach(Element child in ((Xamarin.Forms.Grid)element).Children) {
									this.traverse(child, type_sel, class_sel, selector_index);
								}
							}
						} else if(element_type == "Xamarin.Forms.Frame") {
							this.traverse((Element)((Xamarin.Forms.ContentView)element).Content, type_sel, class_sel, selector_index);
						} else if(element_type == "Xamarin.Forms.StackLayout") {
							//foreach(Element child in (List<View>)((StackLayout)element).Children) {
							foreach(Element child in ((StackLayout)element).Children) {
								this.traverse(child, type_sel, class_sel, selector_index);
							}
						} else if(element_type == "Xamarin.Forms.ListView") {
							Xamarin.Forms.ListView listView = (Xamarin.Forms.ListView)element;
							...
							if(propertyInfo != null) {
								foreach(Xamarin.Forms.ViewCell viewCell in (IEnumerable<Cell>)(propertyInfo.GetValue(listView) as ITemplatedItemsList<Cell>)) {
									if(viewCell.BindingContext != null) {
										this.traverse((Element)viewCell, type_sel, class_sel, selector_index);
									}
								}
							}
						} else if(element_type == "Xamarin.Forms.ScrollView") {
							Xamarin.Forms.ScrollView scroll_view = (Xamarin.Forms.ScrollView)element;
							Element child = scroll_view.Content;
							this.traverse(child, type_sel, class_sel, selector_index);
						} else if(element_type == "Xamarin.Forms.FlexLayout") {
                            Xamarin.Forms.FlexLayout flex_layout = (Xamarin.Forms.FlexLayout)element;
        ...
        public void pushModalAsync(Xamarin.Forms.ContentPage page) {
		...
		public async Task<string> layout_to(View v, double x, double y, Rectangle rect, uint time, Easing easing, AbsoluteLayoutFlags flags=AbsoluteLayoutFlags.None, double width=-1, double height=-1) {
		/*	List<Element> children = this.children(v);
			...
			Rectangle layout_bounds = new Rectangle(x, y, width, height);
        ...
        public void tapped(View v, EventHandler callback, int tap_count=1, bool cancel_color=false) {
            ...
            tap.Tapped += async (s, e) => {
                ...
                //v.Opacity = 0.5;
                if(v.ToString().IndexOf("Xamarin.Forms.Label") != -1) {
                    label = (Label)v;
                ...
                if(v.ToString() == "Xamarin.Forms.Label") {
